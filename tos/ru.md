...
Argon Chat предоставляет платформу для голосового и видеообщения, обмена сообщениями и медиафайлами, аналогичную социальным сетям или сервисам типа Discord. Наш Сервис предназначен для пользователей старше 18 лет.
...
- **Согласие с Политикой конфиденциальности**: При регистрации вы должны согласиться с нашей [Политикой конфиденциальности](ссылка на политику), которая описывает, как мы собираем, используем и защищаем ваши персональные данные.
